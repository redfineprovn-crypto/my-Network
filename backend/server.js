...
const pool = new Pool({
    connectionString: process.env.DATABASE_URL || "postgresql://postgres:AVNS_zs4VoqQXbwdzHYvPiUC@db.dujbquniddoirldqwdfy.pooler.supabase.co:6543/postgres?pgbouncer=true",
    ssl: {
